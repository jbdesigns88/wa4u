            ...
            <section className="py-12">
                <div className="container mx-auto px-6"  >
                    <h2  className="title text-4xl font-bold text-center text-gray-800 mb-6">
                        About Wellness all 4 You
                    </h2>

                    <div className="info-container"  >
                    <p className="text-lg text-gray-600 mb-6">
                        At <span className="font-semibold text-gray-900">Wellness all 4 You</span>, we believe that fitness is not just a goal, but a way of life. 
                    ...
                    <p className="text-lg text-gray-600">
                        ...
                        while ensuring you progress at your own pace. Join us at <span className="font-semibold text-gray-900">Wellness all 4 You</span> and take the next step in your fitness journey today.
                    </p>
                    </div>
                </div>
            </section>
